...
void	pieces_creator()
{
	...
	knight_creator(WHITE, 3, 4);
	// knight_creator(WHITE, 6, 7);
	// knight_creator(BLACK, 1, 0);
	knight_creator(BLACK, 5, 7);
	...
	// }
	pawn_creator(BLACK, 0, 1);
	pawn_creator(BLACK, 1, 1);
	pawn_creator(BLACK, 2, 4);
	pawn_creator(BLACK, 5, 1);
	pawn_creator(BLACK, 6, 1);
	pawn_creator(BLACK, 7, 1);
	pawn_creator(WHITE, 0, 4);
	pawn_creator(WHITE, 0, 5);
	pawn_creator(WHITE, 5, 6);
	pawn_creator(WHITE, 6, 6);
	rook_creator(WHITE, 2, 5);
	// rook_creator(WHITE, 7, 7);
	rook_creator(BLACK, 3, 0);
	rook_creator(BLACK, 4, 0);
	king_creator(WHITE, 5, 5);
	king_creator(BLACK, 2, 0);
}
